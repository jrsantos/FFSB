...
extern rb_node * insert_successor_at(rb_tree * tree,
                                            rb_node * at_node,
                                            datatype object);
...
extern rb_node * insert_predecessor_at(rb_tree * tree,
                                              rb_node * at_node,
                                              datatype object);
 ...
 */
extern rb_node * rbtree_successor(rb_tree * tree,
                                         rb_node * node);
...
extern rb_node * rbtree_predecessor(rb_tree * tree,
                                           rb_node * node);
